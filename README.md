...
See the [full example review](https://mktoronto.github.io/python-clean-architecture/example-review.html) — a color-coded `/review-architecture` run against a test bookstore-api project (15 findings with before/after code).
